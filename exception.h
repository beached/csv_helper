...
namespace daw {
	namespace exception {
#define MAKE_DAW_EXCEPTION( EXCEPTION_NAME ) \
	struct EXCEPTION_NAME: public std::runtime_error { \
		template<typename StringType> \
		EXCEPTION_NAME( const StringType& msg ): std::runtime_error( msg ) { } \
		}
...
#undef MAKE_DAW_EXCEPTION
		...
		void daw_throw( const StringType& msg ) {
			throw ExceptionType( msg );
		}

		template<typename ExceptionType = std::runtime_error, typename StringType>
		void debug_throw( const StringType& msg ) {
#ifndef NODEBUGTHROW
		...
		void dbg_throw_on_null( ValueType* value, const StringType& msg ) {
			if( nullptr == value ) {
		...
		template<typename ExceptionType = NullPtrAccessException, typename ValueType, typename StringType>
		ValueType* dbg_throw_on_null_or_return( ValueType* value, const StringType& msg ) {
			if( nullptr == value ) {
				debug_throw<ExceptionType>( msg );
			}
			return value;
		...
		ValueType& dbg_throw_on_false_or_return( ValueType& value, bool test, const StringType& msg ) {
			if( !test ) {
				debug_throw<ExceptionType>( msg );
			}
			return value;
		...
		bool dbg_throw_on_false_or_return( bool test, const StringType& msg ) {
			if( !test ) {
				debug_throw<ExceptionType>( msg );
			}
			return true;
		...
		template<typename ExceptionType = AssertException, typename StringType>
		void dbg_throw_on_false( bool test, const StringType& msg ) {
			if( !test ) {
				debug_throw<ExceptionType>( msg );
			}
		}
		...
		void dbg_throw_on_false( bool test, const StringType& format, Arg arg, Args... args ) {
			if( !test ) {
		...
		template<typename ExceptionType = AssertException, typename ValueType, typename StringType>
		ValueType& dbg_throw_on_true_or_return( ValueType& value, bool test, const StringType& msg ) {
			if( test ) {
				debug_throw<ExceptionType>( msg );
			}
			return value;
		...
		bool dbg_throw_on_true_or_return( const BoolType& test, const StringType& msg ) {
			if( test ) {
				debug_throw<ExceptionType>( msg );
			}
			return test;
		...
		template<typename ExceptionType = AssertException, typename StringType>
		void dbg_throw_on_true( bool test, const StringType& msg ) {
			if( test ) {
				debug_throw<ExceptionType>( msg );
			}
		}
		...
		template<typename ExceptionType = AssertException, typename StringType, typename Arg, typename... Args>
		void dbg_throw_on_true( bool test, const StringType& format, Arg arg, Args... args ) {
			if( test ) {
				debug_throw<ExceptionType>( daw::string::string_format( format, arg, args... ) );
			}
		}
		...
		template<typename ExceptionType = NullPtrAccessException, typename ValueType, typename StringType>
		void daw_throw_on_null( ValueType* value, const StringType& msg ) {
			if( nullptr == value ) {
				daw_throw<ExceptionType>( msg );
			}
		}
		...
		template<typename ExceptionType = AssertException, typename ValueType, typename StringType>
		ValueType* daw_throw_on_null_or_return( ValueType* value, const StringType& msg ) {
			if( nullptr == value ) {
				daw_throw<ExceptionType>( msg );
			}
			return value;
		...
		template<typename ExceptionType = AssertException, typename BoolType, typename StringType>
		void daw_throw_on_false( const BoolType& test, const StringType& msg ) {
			if( !test ) {
				daw_throw<ExceptionType>( msg );
			}
		}
		...
		template<typename ExceptionType = AssertException, typename StringType, typename Arg, typename... Args>
		void daw_throw_on_false( bool test, const StringType& format, Arg arg, Args... args ) {
			if( !test ) {
				daw_throw<ExceptionType>( daw::string::string_format( format, arg, args... ) );
			}
		}
		...
		ValueType& daw_throw_on_true_or_return( ValueType&& value, bool test, const StringType& format, Arg arg, Args... args ) {
			if( test ) {
				daw_throw<ExceptionType>( daw::string::string_format( format, arg, args... ) );
			}
			return std::forward( value );
		...
		template<typename ExceptionType = AssertException, typename StringType>
		bool daw_throw_on_true_or_return( bool test, const StringType& msg ) {
			if( test ) {
				daw_throw<ExceptionType>( msg );
			}
			return false;
		...
		template<typename ExceptionType = AssertException, typename StringType, typename Arg, typename... Args>
		bool daw_throw_on_true_or_return( bool test, const StringType& format, Arg arg, Args... args ) {
			if( test ) {
				daw_throw<ExceptionType>( daw::string::string_format( format, arg, args... ) );
			}
			return false;
		...
		template<typename ExceptionType = AssertException, typename StringType>
		void daw_throw_on_true( bool test, const StringType& msg ) {
			if( test ) {
				daw_throw<ExceptionType>( msg );
			}
		}
		...
		template<typename ExceptionType = AssertException, typename StringType, typename Arg, typename... Args>
		void daw_throw_on_true( bool test, const StringType& format, Arg arg, Args... args ) {
			if( test ) {
				daw_throw<ExceptionType>( daw::string::string_format( format, arg, args... ) );
			}
		}
